                        ...
                        <div class="modal-body">
                            ...
                            <form  class="needs-validation "   action="proc_cad_pagamento.php?action=ateste"  method="post" novalidate>         
                                <div  class="container" >
                                    ...
                                    <input class="form-control"  type="hidden" name="verif" id="cid_pag"  value="<?php echo $verif; ?>" >
                                    ...
                                    <input class="form-control"  type="hidden" name="pesquisa" id="cid_tipo"  value="list3" >
