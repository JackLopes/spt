...
<table class="table table-hover table-striped table-sm table-bordered light"   >
    ...
    <th scope="col"  data-toggle="tooltip" data-placement="top" title="Tooltip na parte superior">Regional</th> 
...
if (!empty($pesquisa)) {
    ...
    $sqlcorre = "SELECT * FROM pagamentos WHERE  MONTH(data_fim_per)= '$me1' AND  YEAR(data_fim_per)= '$an' ORDER BY (regional) ASC";
    $resultado = mysqli_query($conection, $sqlcorre)or die('Não foi possivel conectar ao MySQL');
}
while ($registro = mysqli_fetch_array($resultado)) {
    ...
    if (!empty($registro['nota_fiscal'])) {
        $nota = "<font style='color:#007bff;' class='btn btn-outline-primary'> " . $registro['nota_fiscal'] . " </font>";
    } else {
    ...
    $sqlcolaborador = "SELECT * FROM responsaveis WHERE responsabilidade='Fiscal Administrativo'  AND id_contrato='$id_contrato'";
        ...
        <tbody>
            <tr >
              ...
              <td class="set1"><a class="btn btn-outline-primary" href="idex.php?id=<?php echo $id_contrato ?>"><?php echo $registro2['rg']; ?></a></td>
                ...
                <td class="set1"><?php echo number_format($registro['valor_parcela'], 2, ',', '.'); ?></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"id="exampleModalLabel" text="center" ><font color='RED'><?php echo 'REGIONAL: ' . $registro['regional'] ?></font></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form  class="needs-validation "   action="proc_cad_pagamento.php?action=ateste"  method="post" novalidate>         
                            <div  class="container" >
                                ...
                                <input class="form-control"  type="hidden" name="pesquisa" id="cid_tipo"  value="list1" >
