...
<html lang="pt">
    ...
    <head>
        ...
        <script>
            ...
            function openWindow(select) {
                ...
                window.open(value, 'popup', 'width=1300,height=800,scrolling=auto,top=0,left=0')
            }
        </script>
        <style>
            table{
    ...
    <body style="background:#cfcfcf;"   onunload="window.opener.location.reload();">
        <?php 
                    ...
                    <main role="main" class="col-md-8 ml-sm-6 col-lg-10 pt-0">
                        ...
                        <table  class="table  table-striped table-hover table-bordered table-sm" style="margin-top: -15px"  >	
                            ...
                            while ($registro = mysqli_fetch_array($resultado)) {
                               ...
                               $registro_func = busca_entidade_id($id_prestador);
                                ...
                                echo "<p><tr><td width='20px '><b>REGIONAL:</td><td  >  " . $registro_func['nome'] . "</td><tr>";
                                echo "<tr><td><b>CNPJ:</td><td> " . $registro_func['cnpj']  . "</td><tr>";
                                echo "<tr><td><b>ENDEREÇO:</td><td> " . $registro_func['endereco']  . "</td><tr>";
                            }
                            echo "</table>";
                            ?>
                            ...
                            <table class="table table-sm table-hover table-bordered"  id="tbl_1" >
                                ...
                                while ($registro7 = mysqli_fetch_array($resultado7)) {
                                    ?>                           
                                    <tr>
                                        <td  > <!--<a class="btn btn-outline-primary" href="#" onclick="window.open('cad_itens.php?id_tipo=<?php echo $registro7['id_tipo']; ?>&sinal=sinal', 'popup4', 'width=1400,height=700,scrolling=auto,top=0,left=0');
                                                return false;">--><?php echo $registro7['tipos']; ?><!-- </a>--></td>
                                        <?php if ($matricula === $mat AND $permissa < 4 or $permissa == '2') { ?>
                                            <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <ul class="nav justify-content-center">     
                                                        <li class="nav-item">
                                                            <a class="btn btn-danger" href="inf_local2.php?acao=apagar&id=<?php echo $id_loc ?>&ct=<?php echo $ct ?>&id_tipo=<?php echo $registro7['id_tipo'] ?>">Sim</a>
                                                        </li>
                                        ...
                                        ?>
                                            ...
                                            <table class="table table-sm table-hover table-bordered" >
                                                ...
                                                while ($registro = mysqli_fetch_array($resultado)) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td  ><?php echo $registro['responsabilidade']; ?></td>	
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <ul class="nav justify-content-center">     
                                                                        <li class="nav-item">
                                                                            <a class="btn btn-danger" href="inf_local2.php?acao=apagar&id=<?php echo $id_loc ?>&ct=<?php echo $ct ?>&id_resp=<?php echo $registro['id_resp'] ?>">Sim</a>
                                                                        </li>
                                                                        <li style="margin-left:30px" class="nav-item">
                                                                            <a style=" color: #FFFFFF" class="btn btn-success"  data-dismiss="modal">Nao</a>
                                                                        </li>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <select  class="form-control" name="id_contrato"onchange="openWindow(this);">
                                                                        ...
                                                                        while ($row = mysqli_fetch_assoc($r1)) {
                                                                            ?>
                                                                            <option value= "inf_local2.php?id=<?php echo $row['id_local']; ?>&ct=<?php echo $ct; ?>"><?php echo $row['lugar_regional']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
