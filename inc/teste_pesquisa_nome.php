...
$startTime1 = mktime(0, 0, 0, date('m'), 1, date('Y'));
$endTime1 = mktime();
...
while ($registro1 = mysqli_fetch_array($resultado1)) {
    ...
    $sqlcorre = "SELECT * FROM pagamentos WHERE  data_fim_per BETWEEN '$inicio' AND ' $final'  AND id_contrato ='$id_contrato' AND medido !='Sim' ORDER BY (data_fim_per) DESC";
    ...
    while ($registro = mysqli_fetch_array($resultado)) {
        ...
        while ($registro2 = mysqli_fetch_array($result)) {
            ...
            <tbody>
                <tr >
                    <td style=" font-size: 30px; font-weight: bold;font-family: time new romam; " ><a class="btn btn-outline-primary"  href="cad_pag.php?action=0&id_tipo=<?php echo $id_tipo ?>&menu=2"><?php echo $registro['regional']; ?></a></td>
                    <td><?php echo $nome; ?></td>
                    <td ><?php echo inverteData($registro['recebimento_nota']); ?></td>
                    <td class="set1"><a href="idex.php?id=<?php echo $id_contrato ?>"><?php echo $registro2['rg']; ?></a></td>
                    <td ><?php echo $ref; ?></td>
                        ...
                        <div class="modal-body">
                            ...
                            <form  class="needs-validation "   action="proc_cad_pagamento.php?action=ateste"  method="post" novalidate>         
                                <div  class="container" >
                                    ...
                                    <input class="form-control"  type="hidden" name="inicial" id="cid_tipo"  value="<?php echo $inicial; ?>" >
                                    <input class="form-control"  type="hidden" name="final" id="cid_tipo"  value="<?php echo $final; ?>" >
                                    <input class="form-control"  type="hidden" name="rg" id="cid_tipo"  value="<?php echo $rg; ?>" >
                                    <input class="form-control"  type="hidden" name="pesquisa" id="cid_tipo"  value="<?php echo $pesquisa; ?>" >
