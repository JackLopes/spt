<div class="form-group col-md-12">
     ...
     <?php
           require './gatway_corretiva.php';
            echo total_ocorrencia_nome($nome);             
    ...
    <table  class="table table-hover table-striped table-sm table-bordered bg-light"   >
        ...
        while ($registro1 = mysqli_fetch_array($resultado1)) {
            ...
            $sqlcorre = "SELECT * FROM corretivas WHERE id_contrato = '$id_contrato' and previsao_multa = '1' And aplicacao_multa ='Verificar' ORDER BY (data_conclusao) DESC";
            ...
            while ($registro = mysqli_fetch_array($resultado)) {
                ...
                <tr>
                    ...
                    <td class = "set1" ><a  data-toggle="modal"  <?php if ($matricula === $mat AND $permissa < 4 or $permissa == '2') { ?> data-target="#exampleModal3<?php echo $id_corretiva ?>"  <?php } ?> href="#" ><?php echo $registro['aplicacao_multa']; ?></td>
