...
$page_title = '';
$assunt = "<font style='color: #df7700 ; '><i class='fas fa-database'></i></font> Controle do Processo de Entrega de Itens<p style='margin-left:50px;font-family:times new roman';> $nome1 </p><p>$rg1</p>";
    ...
    <body>
        ...
        <div  class=" container-fluid    " >
            ...
            <div class="form-group col-md-12">
                <form   style="background-color:#f8f9fa; margin-top: 20px;" action="controle_itens.php?action=pesquisa" method="post">
            ...
            <div class="form-group col-md-12">
                ...
                if (!empty($rg) || !empty($nome)) {
                    include_once 'control_itens_nome.php';
                }  else {
                    include_once 'control_itens_geral.php';
                }
                ?>
            </div>
        </div>
