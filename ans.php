...
<html lang="pt">
    ...
    <body  style="background-color: #cfcfcf;">
        <nav class="navbar navbar-light bg-light">
            <a class="navbar-brand" href="idex.php?id=<?php echo $id; ?>"><i class="fas fa-undo-alt"></i> RETORNAR  </a>
                        ...
                        <div class="row"  >
                            ...
                            <div class="col-sm-3 ">
                                <select class="form-control"   id="cano" name="ano">
                                    ...
                                    <?php
                                    $sql = "  SELECT   ano  FROM corretivas WHERE   id_contrato = '$id '
                                              UNION
                                              SELECT   ano  FROM preventivas WHERE   id_contrato = '$id '                                            
                                              GROUP BY YEAR(ano)";
