                ...
                <nav id="naviselect" class="col-md-2 d-none d-md-block bg-light sidebar">
                    ...
                    <div class="sidebar-sticky">
                        ...
                        <ul class="nav flex-column mb-2">
                            <li class="nav-item">
                                <a class="nav-link" href="atu_prestador.php?id_prest=<?php echo $id_prest ?>"> 				           
                                   <i class="fas fa-dolly-flatbed"></i>  Prestador
                                </a>
                            </li>             
                        </ul>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <ul class="nav justify-content-center">     
                                            <li class="nav-item">
                                                <a class="btn btn-danger"  href="inf_prestador.php?id=<?php echo $registro['id_presta'] ?>&id_colaborador=<?php echo $registro['id_colaborador']; ?>&ct=<?php echo $registro['id_contrato']; ?>">Sim</a>
                                            </li>
