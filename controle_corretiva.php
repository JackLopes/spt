...
$page_title = '';
$assunt = "<font style='color: #df7700 ; '><i class='fas fa-wrench'></i></font> Controle do Processo de Aplicação de Penalidade (Manutenção Corretiva)<p style='margin-left:50px;font-family:times new roman';> $nome1 </p><p>$rg1</p>";
    ...
    <body>
        ...
        <div  class=" container-fluid    " >
            ...
            <div class="form-group col-md-12">
                <form   style="background-color:#f8f9fa; margin-top: 20px;padding: 30px; border-radius: 20px;" action="controle_corretiva.php?action=pesquisa" method="post">
            ...
            <div class="form-group col-md-12">
                ...
                <?php
                if (!empty($rg)) {
                    include_once 'control_corretiva_rg.php';
                } else if (!empty($nome)) {
                    include_once 'control_corretiva_nome.php';
                } else {
                    include_once 'control_corretiva_geral.php';
                }
                ?>
            </div>
        </div>
