...
$mpdf->SetHTMLHeader("
<img id='imge' src='img/serpro4.jpg' width='100'  />
<div style='text-align: right; font-weight: bold; margin-top:-30px;margin-bottom: 40px;'>


  <strong id = 'obje'>Previsão de Incidência Contratual  - $penalidade   <hr id='lin'>  <p id='tit'>  RG:  $rg - $nom  </p> 
