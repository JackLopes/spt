...
if (isset($_SESSION['dados']['id_contrato'])) {
    $id_contrato = (int) $_SESSION['dados']['id_contrato'];
}
if (isset($_SESSION['dados']['id_contrato'])) {
    $valor_garantia_exc = (int) $_SESSION['dados']['valor_garantia_exc'];
}
                        ...
                        <div class="row"> 
                            <div class="col-md-4 mb-3">
                                <div class="input-field col s12">
                                    ...
                                    <select   type="text" name="status" id="cstatus" value="<?php
                                    if (isset($_SESSION['dados']['status'])) {
                                        echo $_SESSION['dados']['status'];
                                    } elseif (isset($id_contrato)) {
                                        echo $status;
                                    }
                                    ?>"  required>
                                        <option selected><?php
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="input-field col s12">
                                    ...
                                    <input  Type="text" name="rg" id="crg"  value="<?php
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="input-field col s12">
                                    <input  class="form-control-plaintext" Type="text" name="n_siscor" id="cn_siscor"  value="<?php
                                    if (isset($_SESSION['dados']['n_siscor'])) {
                                        echo $_SESSION['dados']['n_siscor'];
                                    } elseif (!empty($id_contrato)) {
                                        echo $n_siscor;
                                    }
                                    ?>" >
                                    <label for="disabled">SISCOR Inicial:</label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input  class="form-control-plaintext"  Type="text" name="projeto_basico" id="cprojeto_basico" value="<?php
                                if (isset($_SESSION['dados']['projeto_basico'])) {
                                    echo $_SESSION['dados']['projeto_basico'];
                                } elseif (!empty($id_contrato)) {
                                    echo $projeto_basico;
                                }
                                ?>" />
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select  class="form-control-plaintext"  Type="text" name="pos_prorrogacao" id="cpos_prorrogacao"  maxlength="40" onchange="esconDiv2(this.value)" >
                                    <optgroup label="Selecione">
                                        <option selected><?php
                                            if (isset($_SESSION['dados']['pos_prorrogacao'])) {
                                                echo $_SESSION['dados']['pos_prorrogacao'];
                                            } elseif (!empty($id_contrato)) {
                                                echo $pos_prorrogacao;
                                            }
                                            ?></option>
...
<?php } ?>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input  class="form-control-plaintext"  Type="text" name="pasta" id="clink_pv"  value="<?php
                                if (isset($_SESSION['dados']['pasta'])) {
                                    echo $_SESSION['dados']['pasta'];
                                } elseif (!empty($id_contrato)) {
                                    echo $pasta;
                                }
                                ?>">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input  class="form-control-plaintext" Type="url" name="link_pv" id="clink_pv"  value="<?php
                                if (isset($_SESSION['dados']['link_pv'])) {
                                    echo $_SESSION['dados']['link_pv'];
                                } elseif (!empty($id_contrato)) {
                                    echo $link_pv;
                                }
                                ?>">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input  class="form-control-plaintext" Type="url" name="link_ged" id="clink_ged" value="<?php
                                if (isset($_SESSION['dados']['link_ged'])) {
                                    echo $_SESSION['dados']['link_ged'];
                                } elseif (!empty($id_contrato)) {
                                    echo $link_ged;
                                }
                                ?>">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input  class="form-control-plaintext" Type="url" name="link_proscorm" id="clink_proscorm" value="<?php
                                if (isset($_SESSION['dados']['link_proscorm'])) {
                                    echo $_SESSION['dados']['link_proscorm'];
                                } elseif (!empty($id_contrato)) {
                                    echo $link_proscorm;
                                }
                                ?>" >
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control-plaintext" Type="text" name="natureza" id="cnatureza"   ><br />				
                                    <option selected><?php
                                        if (isset($_SESSION['dados']['natureza'])) {
                                            echo $_SESSION['dados']['natureza'];
                                        } elseif (!empty($id_contrato)) {
                                            echo $natureza;
                                        }
                                        ?></option>
...
<?php } ?>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input class="form-control-plaintext" Type="text" name="n_processo" id="cn_processo" size="15" maxlength="40" placeholder= "Nº Processo Verde"value="<?php
                                if (isset($_SESSION['dados']['n_processo'])) {
                                    echo $_SESSION['dados']['n_processo'];
                                } elseif (!empty($id_contrato)) {
                                    echo $n_processo;
                                }
                                ?>" />
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control-plaintext" Type="text" name="objeto" id="cobjeto" value="<?php
                                if (isset($_SESSION['dados']['objeto'])) {
                                    echo $_SESSION['dados']['objeto'];
                                } elseif (!empty($id_contrato)) {
                                    echo $objeto;
                                }
                                ?>" />
                        ...
                        <div style="margin-top:20px;" class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input class="form-control-plaintext"  Type="text"   name="valor_Contratado" id="campovalor" value="<?php
                                if (isset($_SESSION['dados']['valor_Contratado'])) {
                                    echo $_SESSION['dados']['valor_Contratado'];
                                } elseif (!empty($id_contrato)) {
                        ...
                        <div class="row"> 
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control-plaintext"  id="campovalor1" name="percent_atrasoEntrega" value="<?php
                                if (isset($_SESSION['dados']['percent_atrasoEntrega'])) {
                                    echo $_SESSION['dados']['percent_atrasoEntrega'];
                                } elseif (!empty($id_contrato)) {
                                    echo $percent_atrasoEntrega;
                                }
                                ?>" >
                            </div>
                            <div class="form-group col-md-4">
                                <label for="address">Não entregha do objeto:</label>
                                <input type="text" class="form-control-plaintext" id="campovalor2" name="percent_naoObjeto"  value="<?php
                                if (isset($_SESSION['dados']['percent_naoObjeto'])) {
                                    echo $_SESSION['dados']['percent_naoObjeto'];
                                } elseif (!empty($id_contrato)) {
                                    echo $percent_naoObjeto;
                                }
                                ?>" >
                            </div>
                            <div class="form-group col-md-4">
                                <label for="address">Descumprimento de cláusula:</label>
                                <input type="text" class="form-control-plaintext" id="campovalor3" name="percent_descumprimento" value="<?php
                                if (isset($_SESSION['dados']['percent_descumprimento'])) {
                                    echo $_SESSION['dados']['percent_descumprimento'];
                                } elseif (!empty($id_contrato)) {
                                    echo $percent_descumprimento;
                                }
                                ?>" >
                            </div>
                            <div class="form-group col-md-4">
                                <label for="address">Limite Parcial:</label>
                                <input type="text" class="form-control-plaintext" id="campovalor4" name="limiteParcial" value="<?php
                                if (isset($_SESSION['dados']['limiteParcial'])) {
                                    echo $_SESSION['dados']['limiteParcial'];
                                } elseif (!empty($id_contrato)) {
                                    echo $limiteParcial;
                                }
                                ?>" >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control-plaintext" id="campovalor5" name="limiteTotal"  value="<?php
                                if (isset($_SESSION['dados']['limiteTotal'])) {
                                    echo $_SESSION['dados']['limiteTotal'];
                                } elseif (!empty($id_contrato)) {
                                    echo $limiteTotal;
                                }
                                ?>" >
                        ...
                        <div class="row"> 
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control-plaintext" Type="number" name="vig_contrat" id="cvig_contrat" value="<?php
                                if (isset($_SESSION['dados']['vig_contrat'])) {
                                    echo $_SESSION['dados']['vig_contrat'];
                                } elseif (!empty($id_contrato)) {
                                    echo $vig_contrat;
                                }
                                ?>" >
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control-plaintext"  Type="Date" name="d_Inic_vige_contr" id="cd_Inic_vige_contr" size="40" maxlength="40" value="<?php
                                if (isset($_SESSION['dados']['d_Inic_vige_contr'])) {
                                    echo $_SESSION['dados']['d_Inic_vige_contr'];
                                } elseif (isset($id_contrato)) {
                                    echo $d_Inic_vige_contr;
                                }
                                ?>">
                            </div> 
                        ...
                        <div class="row"> 
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control-plaintext" Type="Date" name="d_Assinatura" id="cd_Assinatura"  value="<?php
                                if (isset($_SESSION['dados']['d_Assinatura'])) {
                                    echo $_SESSION['dados']['d_Assinatura'];
                                } elseif (!empty($id_contrato)) {
                                    echo $d_Assinatura;
                                }
                                ?>" >
    ...
    <?php } ?>
                            ...
                            <div class="teste row"> 
                                <div  class="teste col-md-4 mb-4  div2 ">
                                    ...
                                    <input class="form-control" Type="number" name="vig_garantia" min="1"  max="999" id="cvig_garantia" value="<?php
                                    if (isset($_SESSION['dados']['vig_garantia'])) {
                                        echo $_SESSION['dados']['vig_garantia'];
                                    } elseif (isset($id_contrato)) {
                                        echo $vig_garantia;
                                    }
                                    ?>" >
                            ...
                            <div class="teste row"> 
                                ...
                                <div  class=" teste col-md-3 mb-3">
                                    ...
                                    <input class="form-control" Type="text" name="periodo_garantia_exc" id="cvig_contrat" value="<?php
                                    if (isset($_SESSION['dados']['periodo_garantia_exc'])) {
                                        echo $_SESSION['dados']['periodo_garantia_exc'];
                                    } elseif (!empty($id_contrato)) {
                                        echo $periodo_garantia_exc;
                                    }
                                    ?>" >
                                </div> 
                                <div  class="col-md-3 mb-3"  >
                            ...
                            <div  class="teste1 row"> 
                                <div   class="teste1 form-group col-md-4">
                                    ...
                                    <select class="form-control"  Type="number" name="tip_chamado" id="ctip_chamado"  maxlength="40" value="<?php if (isset($_SESSION['dados']['tip_chamado'])) echo $_SESSION['dados']['tip_chamado']; ?>" >
                                        <option selected><?php
                                            if (isset($_SESSION['dados']['tip_chamado'])) {
                                                echo $_SESSION['dados']['tip_chamado'];
                                            } elseif (!empty($id_contrato)) {
                                                echo $tip_chamado;
                                            }
                                            ?></option>
                                ...
                                <div   class="teste1 form-group col-md-8">
                                    ...
                                    <select class="form-control"  Type="text" name="parametro_multa" id="cparametro_multa"  maxlength="40" value="<?php if (isset($_SESSION['dados']['parametro_multa'])) echo $_SESSION['dados']['parametro_multa']; ?>" >
                                        <option selected><?php
                                            if (isset($_SESSION['dados']['parametro_multa'])) {
                                                echo $_SESSION['dados']['parametro_multa'];
                                            } elseif (!empty($id_contrato)) {
                                                echo $parametro_multa;
                                            }
                                            ?></option>
